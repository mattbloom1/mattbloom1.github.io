/* Lucide icons (lucide.dev, ISC licence), inlined so print and offline
   both work. All 24x24; stroke styling comes from the page CSS. */
window.ICONS = {
  ...
  school:   '<path d="M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.83l8.57 3.908a2 2 0 0 0 1.66 0z"/><path d="M22 10v6"/><path d="M6 12.5V16a6 3 0 0 0 12 0v-3.5"/>',
  ...
  clapper:  '<path d="m4 11-.88-2.87a2 2 0 0 1 1.33-2.5l11.48-3.5a2 2 0 0 1 2.5 1.32l.87 2.87L4 11.01Z"/><path d="m6.6 4.99 3.38 4.2"/><path d="m11.86 3.38 3.38 4.2"/><path d="M3 11h18v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z"/>',
...
window.icon = function (n, cls) {
  return '<span class="ico' + (cls ? ' ' + cls : '') + '">' +
         '<svg viewBox="0 0 24 24" aria-hidden="true">' + (window.ICONS[n] || '') + '</svg></span>';
};
